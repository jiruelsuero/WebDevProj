...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 11, 2024 at 02:37 PM
...
(21, 1, 1, 1, '2024-12-11 11:57:08'),
(22, 1, 1, 1, '2024-12-11 12:00:48'),
(23, 1, 1, 1, '2024-12-11 12:00:58'),
(24, 1, 2, 4, '2024-12-11 12:05:12'),
(25, 1, 3, 3, '2024-12-11 12:05:21'),
(26, 1, 1, 1, '2024-12-11 12:05:53'),
(27, 1, 8, 2, '2024-12-11 12:09:26'),
(28, 1, 11, 1, '2024-12-11 12:14:14'),
(29, 1, 3, 1, '2024-12-11 12:39:20'),
(30, 1, 1, 2, '2024-12-11 12:43:52'),
(31, 1, 4, 2, '2024-12-11 12:48:54');
...
INSERT INTO `reservations` (`reservation_id`, `user_id`, `product_id`, `quantity`, `reserved_at`) VALUES
(63, 1, 4, 2, '2024-12-11 12:49:27');
...
ALTER TABLE `reservations`
  ...
  ADD CONSTRAINT `reservations_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`);
